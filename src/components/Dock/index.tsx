...
const Dock: React.FC = () => {
    const DEFAULT_LENGTH = 68; // default length for Docker icons
    const BOUNCE_ANIMATION_DURATION = 1.5 * 1000; // time of icon bounce when putting mouse on the icon
    ...
    // recalculate the icon styles (margins) while icons are bouncing
    // use useMemo to avoid duplicated calculations
